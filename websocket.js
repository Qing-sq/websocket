...
var userId = base64.decode(wx.getStorageSync('info').useruseruser);
// socket已经连接成功
...
var webSocket = {
  ...
  connectSocket: function(options) {
    ...
    console.log(userId,'解密',wx.getStorageSync('info').useruseruser)
    socketOpen = false
    socketClose = false
    socketMsgQueue = []
    wx.connectSocket({
      url: wsUrl + '/wsImserver/' + userId,
